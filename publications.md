...
<div class="rp-hero">
  <p class="rp-hero-sub">
    Peer-reviewed publications, preprints, presentations, and research outputs.
  </p>
</div>
...
<div class="rp-card accent-purple">
  <div class="rp-title"><span class="rp-title-icon">📚</span>Preprints &amp; Conference Submissions</div>

  <p class="rp-muted">
    Preprints and additional conference abstracts will be added here as they become available.
  </p>
</div>
